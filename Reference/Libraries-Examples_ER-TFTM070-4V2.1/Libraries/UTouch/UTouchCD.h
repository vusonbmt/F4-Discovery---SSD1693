...
// These calibration settings works with my ER-TFTM070-4
// They MIGHT work on your display module, but you should run the
// calibration sketch anyway


#define CAL_X 0x03FAC021UL   //ER-TFTM070-4
#define CAL_Y 0x002F4F49UL   //ER-TFTM070-4
#define CAL_S 0x8031f1dfUL   //ER-TFTM070-4
